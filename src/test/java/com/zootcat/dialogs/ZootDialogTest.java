...
public class ZootDialogTest
{
	...
	{
		ZootDialog dialog = new ZootDialog(dialogPath, ":Test1", ":~Test1", assetManager);
	...
	{		
		ZootDialog dialog = new ZootDialog(dialogWithSettingsPath, ":Test1", ":~Test1", assetManager);
	...
	{
		//when
		ZootDialog dialog = new ZootDialog(dialogPath, ":NoFace", ":~NoFace", assetManager);
	...
	{
		new ZootDialog(dialogPath, ":NoSuchTokens", ":~NoSuchTokens", assetManager);
	}
